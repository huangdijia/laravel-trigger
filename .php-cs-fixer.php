...
return (new Config())
    ->setHeaderComment(
        projectName: 'huangdijia/laravel-trigger',
        projectLink: 'https://github.com/huangdijia/laravel-trigger',
        projectDocument: 'https://github.com/huangdijia/laravel-trigger/blob/4.x/README.md',
        contacts: [
